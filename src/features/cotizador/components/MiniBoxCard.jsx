...
/**
 * Componente para una mini tarjeta de caja individual
 *
...
export const MiniBoxCard = ({
  ...
  const volumetricWeight = Calcs.calculateVolumetricWeight(
    box.length,
    box.width,
    box.height
  );
  const computableWeight = Calcs.calculateComputableWeight(
    box.weight,
    volumetricWeight
  );
      ...
      <div className="flex justify-between items-center">
        ...
        {isRemovable && (
          <button
            ...
            className="cursor-pointer p-3 -m-2 rounded-full text-red-500 hover:text-red-700 hover:bg-red-100 transition-colors"
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="col-span-1">
          ...
          <input
            ...
            placeholder="0"
            className="h-9 w-full bg-white rounded-md border border-sky-200 shadow-sm 

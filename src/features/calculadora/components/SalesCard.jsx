...
export const SalesCard = ({
  ...
  const hasAdvancedValues =
    paymentFeePercent > 0 || installmentFeePercent > 0 ||
    taxesAndRetentions > 0 || sellerShippingCost > 0 || promotionalDiscount > 0;
  ...
  return (
    <Card
      ...
      tooltip="Configurá el precio de venta bruto y las deducciones aplicables."
    >
      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
        {/* ── PRIMARY ── */}
        <Input label="Precio de venta" value={grossSellingPrice}
          onChange={onGrossSellingPriceChange} prefix="$"
          tip="Precio de lista antes de descuentos." />

    ...
    return (
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 20px 16px" }}>
                ...
                <img src="/shippar-isotipo.webp" alt="Shippar isotipo — plataforma de importaciones express" loading="lazy" style={{ height: "18px", width: "auto", objectFit: "contain" as const }} />
                <div style={{ width: 18 }} />
            </div>
